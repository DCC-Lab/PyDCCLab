...
setuptools.setup(
    ...
    install_requires=['matplotlib','numpy','scikit-image','scipy','czifile >= 2019.6.18','tifffile','read-lif','opencv-python','xlrd','seaborn','imagecodecs','deprecated','keyring','sshtunnel'],
    python_requires='>=3',
    package_data={
