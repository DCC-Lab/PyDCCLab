...
Everything needs to be unit tested.  Import `env` first.  A testcase file should look like this:
...
If generally useful functions are needed, they should go there.